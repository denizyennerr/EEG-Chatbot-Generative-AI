...
if __name__ == "__main__":
    ...
    try:
        audio_text = recognizer.recognize_google(audio).lower()
    except sr.UnknownValueError:
        audio_text = "male"  # Default to male if not understood
...
user_input = input("I have a headache and fever")
calling_the_bot(user_input)
